...
uint16_t alt_transform(uint16_t kc) {
    ...
    switch (kc) {
        case KC_Q: return KC_V;
        case KC_W: return KC_M;
        case KC_E: return KC_L;
        case KC_R: return KC_C;
        case KC_T: return KC_P;
        ...
        case KC_A: return KC_S;
        case KC_S: return KC_T;
        case KC_D: return KC_R;
        case KC_F: return KC_D;
        ...
        case KC_QUOT: return KC_SLSH;

        case KC_Z: return KC_Z;
        case KC_X: return KC_K;
        case KC_C: return KC_Q;
        case KC_V: return KC_G;
        case KC_B: return KC_W;
        case KC_N: return KC_B;
        case KC_M: return KC_H;
        case KC_COMM: return KC_QUOT;
        case KC_DOT: return KC_SCLN;
        case KC_SLSH: return KC_COMM;
