...
uint16_t alt_transform(uint16_t kc) {
    ...
    switch (kc) {
        ...
        case KC_T: return KC_QUOT;
        case KC_Y: return KC_MINS;
        case KC_U: return KC_L;
        case KC_I: return KC_D;
        case KC_O: return KC_W;
        case KC_P: return KC_V;
        case KC_MINS: return KC_Z;

        case KC_A: return KC_C;
        ...
        case KC_QUOT: return KC_Q;

        case KC_Z: return KC_G;
        case KC_X: return KC_X;
        case KC_C: return KC_J;
        case KC_V: return KC_K;
        case KC_B: return KC_SLSH;
        case KC_N: return KC_SCLN;
        case KC_M: return KC_R;
        case KC_COMM: return KC_M;
        case KC_DOT: return KC_F;
        case KC_SLSH: return KC_P;
