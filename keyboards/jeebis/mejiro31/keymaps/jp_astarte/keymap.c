...
static inline uint16_t alt_transform(uint16_t kc) {
    ...
    switch (kc) {
        ...
        case KC_R: return KC_Y;
        case KC_T: return KC_COMM;
        case KC_Y: return KC_J;
        case KC_U: return KC_D;
