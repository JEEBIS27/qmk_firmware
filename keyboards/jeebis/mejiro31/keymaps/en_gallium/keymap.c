...
uint16_t alt_transform(uint16_t kc) {
    ...
    switch (kc) {
        ...
        case KC_Y: return KC_Z;
        case KC_U: return KC_Y;
        case KC_I: return KC_O;
        case KC_O: return KC_U;
        case KC_P: return KC_COMM;
        ...
        case KC_V: return KC_W;
        case KC_B: return KC_J;
        case KC_N: return KC_K;
        case KC_M: return KC_F;
        case KC_COMM: return KC_QUOT;
        case KC_DOT: return KC_SCLN;
        case KC_SLSH: return KC_DOT;
